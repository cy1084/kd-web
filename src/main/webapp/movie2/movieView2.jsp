...
<body>
	...
	<script>
		alert('이미 삭제된 영화입니다.');
		location.href = '/web/movie/movieList2.jsp';
	</script>
	<%
	return;
	}
	...
	<table border="1">
		...
		<tr>
			<th colspan="2">
				<button onclick="location.href='<%=root%>/movie2/movieUpdate2.jsp?miNum=<%=miNum%>'">수정</button>
				<button onclick="location.href='<%=root%>/movie2/movieDelete2.jsp?miNum=<%=miNum%>'">삭제</button>
			</th>
		</tr>
